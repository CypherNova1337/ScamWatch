...
Why ScamWatch works the way it does. Everything here was measured while
building it, not reasoned about in the abstract — the numbers are from live
runs against the real services.

See the [README](../README.md) to install and run it.
